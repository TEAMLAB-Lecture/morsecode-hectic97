...
def decoding_character(morse_character):
    ...
    result = {v:k for k,v in morse_code_dict.items()}[morse_character]
    return result
    # ==================================
...
def main():
    ...
    while True:
        ...
        if msg == '0':
            ...
            print(encoding_sentence(get_cleaned_english_sentence(msg)))
